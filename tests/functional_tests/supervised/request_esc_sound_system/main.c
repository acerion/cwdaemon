...
/// @file
///
/// Tests of SOUND_SYSTEM Escape request (<ESC>f).
...
static char const * g_test_name = "SOUND_SYSTEM Escape request";
...
int main(int argc, char * const * argv)
{
	...
	// If a sound system is not provided through command line, it will stay
	// here as CW_AUDIO_NONE. Look at how CW_AUDIO_NONE is recognized and
	// interpreted in code starting a cwdaemon server in this test.
	test_options_t test_opts = { .sound_system = CW_AUDIO_NONE };
