...
declare -a commands=("\x1b8/dev/ttyUSB0"
					 "\x1b8/dev/ttyUSB1"
					 "\x1b8/dev/ttyUSB0"
					 "\x1b8/dev/ttyUSB1"
					 "\x1b5"
...
==17385== 8 bytes in 1 blocks are still reachable in loss record 1 of 1
==17385==    at 0x48455EF: calloc (vg_replace_malloc.c:1328)
==17385==    by 0x10DDF0: ttys_init (ttys.c:136)
==17385==    by 0x10C382: cwdaemon_cwdevice_set (cwdaemon.c:2549)
==17385==    by 0x10C7DC: cwdaemon_params_cwdevice (cwdaemon.c:1768)
==17385==    by 0x10C7DC: cwdaemon_handle_escaped_request (cwdaemon.c:1070)
==17385==    by 0x10CF77: cwdaemon_receive (cwdaemon.c:946)
==17385==    by 0x10AD94: main (cwdaemon.c:2374)
